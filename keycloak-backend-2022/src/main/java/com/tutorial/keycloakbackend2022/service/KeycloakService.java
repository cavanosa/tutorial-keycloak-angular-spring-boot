package com.tutorial.keycloakbackend2022.service;

import com.tutorial.keycloakbackend2022.dto.ResponseMessage;
import com.tutorial.keycloakbackend2022.model.User;
...
public class KeycloakService {
    ...
    private RealmResource getRealmResource(){
        Keycloak kc = KeycloakBuilder.builder().serverUrl(server_url).realm("master").username("admin")
                .password("admin").clientId("admin-cli").resteasyClient(new ResteasyClientBuilderImpl().connectionPoolSize(10).build())
                .build();
